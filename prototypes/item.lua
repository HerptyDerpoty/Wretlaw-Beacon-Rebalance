...
beacon2.icon = nil
beacon2.icons = {
	{icon = "__wret-beacon-rebalance-mod-k2-fix__/graphics/icon/beacon2.png", icon_size = 64, icon_mipmaps = 4},
	{icon = "__wret-beacon-rebalance-mod-k2-fix__/graphics/icon/two.png", icon_size = 64, icon_mipmaps = 4, scale = .25, shift = {-8, 8}}
}
...
beacon3.icon = nil
beacon3.icons = {
	{icon = "__wret-beacon-rebalance-mod-k2-fix__/graphics/icon/beacon3.png", icon_size = 64, icon_mipmaps = 4},
	{icon = "__wret-beacon-rebalance-mod-k2-fix__/graphics/icon/three.png", icon_size = 64, icon_mipmaps = 4, scale = .25, shift = {-8, 8}}
}
