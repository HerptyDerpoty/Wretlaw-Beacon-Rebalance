...
--the below is basically copied straight from the Classic Beacon mod by Kirazy. 
    ...
    beacon2.graphics_set.animation_list[1].animation.layers[1] = {
        filename = "__wret-beacon-rebalance-mod-k2-fix__/graphics/entity/beacon/beacon2-base.png",
        width = 232,
        height = 186,
    ...
    beacon2.graphics_set.animation_list[2].animation.layers[1] = {
        filename = "__wret-beacon-rebalance-mod-k2-fix__/graphics/entity/beacon/hr-beacon-antenna-green.png",
        width = 108,
        height = 100,
        line_length = 8,
        frame_count = 32,
...
--the below is basically copied straight from the Classic Beacon mod by Kirazy. 
    ...
    beacon3.graphics_set.animation_list[1].animation.layers[1] = {
        filename = "__wret-beacon-rebalance-mod-k2-fix__/graphics/entity/beacon/beacon3-base.png",
        width = 232,
        height = 186,
        shift = util.by_pixel(11*(4/3), 1.5*(4/3)),
        scale = 0.5*(4/3),
    ...
    beacon3.graphics_set.animation_list[2].animation.layers[1] = {
        filename = "__wret-beacon-rebalance-mod-k2-fix__/graphics/entity/beacon/hr-beacon-antenna-blue.png",
        width = 108,
        height = 100,
        line_length = 8,
        frame_count = 32,
...
data:extend{
		...
		--the beacon overload sprite
	{
		...
		filename = '__wret-beacon-rebalance-mod-k2-fix__/graphics/icon/beacon-overload.png',
